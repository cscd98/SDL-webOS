...
#include "SDL_waylandsym.h"
        ...
        /* webOS ships libwayland older than 1.10, which lacks these. The
         * generated protocol code still calls them, so stand in for whatever
         * the runtime didn't provide. */
