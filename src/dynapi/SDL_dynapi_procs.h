...
SDL_DYNAPI_PROC(const char*,SDL_webOSCreateExportedWindow,(SDL_webOSExportedWindowType a),(a),return)
SDL_DYNAPI_PROC(bool,SDL_webOSSetExportedWindow,(const char *a,SDL_Rect *b,SDL_Rect *c),(a,b,c),return)
